...
# Picks up where run_remaining_oom_safe.sh crashed after completing ablations.
# =============================================================================
set -uo pipefail

cd /home/chyanin/robotpaper

LOGFILE="logs/ood_latent_$(date '+%Y%m%d_%H%M%S').log"
mkdir -p logs results/sweeps_multiseed results/latent_analysis

log() { echo "[$(date '+%H:%M:%S')] $1" | tee -a "$LOGFILE"; }

log "================================================================"
log " OOD Sweeps + Latent Analysis"
